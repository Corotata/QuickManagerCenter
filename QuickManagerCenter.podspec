#
# Be sure to run `pod lib lint QuickManagerCenter.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
A short description of QuickManagerCenter.
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'QuickManagerCenter' => ['QuickManagerCenter/Assets/*.png']
  # }
